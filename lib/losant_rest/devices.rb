module LosantRest
  ...
  class Devices
    ...
    def get(params = {})
      ...
      param_key = if params.has_key?("tagFilter")      
        "tagFilter"      
      elsif params.has_key?(:"tagFilter")      
        :"tagFilter"      
      else      
        nil      
      end      
      query_params[:"tagFilter"] = params[param_key] if param_key
    ...
    def send_command(params = {})
      ...
      param_key = if params.has_key?("multiDeviceCommand")      
        "multiDeviceCommand"      
      elsif params.has_key?(:"multiDeviceCommand")      
        :"multiDeviceCommand"      
      else      
        nil      
      end      
